...
export function QuizCreator() {
  ...
  const [difficultyButtonPressed, setDifficultyButtonPressed] = useState(false);
  const [lengthButtonPressed, setLengthButtonPressed] = useState(false);
  ...
  if (nextpage) {
    ...
    if (difficultyButtonPressed & lengthButtonPressed) {
  ...
  function DificultyHighlightButtons() {
    ...
    if (quizdifficulty === 'Easy') {
      ...
      setDifficultyButtonPressed(true)
