  ...
  function handleSubmit(event) {
    ...
    function DificultyHighlightButtons() {
      ...
      className={`${
        ...
        quizdifficulty === "Easy" && "border-black bg-opacity-0 text-purple-600 font-bold border"
     ...
     className={`${
      ...
      quizdifficulty === "Medium" && "border-black bg-opacity-0 text-purple-600 font-bold border"
      ...
      className={`${
        ...
        quizdifficulty === "Hard" && "border-black bg-opacity-0 text-purple-600 font-bold border"
    ...
    function LengthHighlightButtons() {
      ...
      return <>
        ...
        className={`${
          ...
          quizlength=== 5 && "border-black bg-opacity-0 text-purple-600 font-bold border"
        ...
        className={`${
          ...
          quizlength=== 10 && "border-black bg-opacity-0 text-purple-600 font-bold border"
        ...
        className={`${
          ...
          quizlength=== 15 && "border-black bg-opacity-0 text-purple-600 font-bold border"
